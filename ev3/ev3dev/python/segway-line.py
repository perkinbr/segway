...
lightSensorValueRaw  = open("ev3devices/in3/value0", "rb")   
...
while not touchSensorPressed: 
    ...
    ##
    ##  In this case we implement a line following example
    ##
    ###############################################################
 
    # Read the light sensor value    
    lightSensorValue   = FastRead(lightSensorValueRaw)   
    lightTreshold = 19 # The reflected light value just in between black (4%) and white (34%)
    
    # Set speed and steering like in a normal proportional line follower
    speed    = 20
    steeringScale = 1.5
    steering = (lightSensorValue-lightTreshold)*steeringScale
