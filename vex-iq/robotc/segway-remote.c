...
///
/// 1. Put the segway upright, with its wheels resting on the ground.
/// 2. Don't hold it too tightly: just enough to prevent it from falling over.
/// 3. Start the program. The Touch LED will turn blue.
/// 4. Keep holding the Segway upright until the Touch LED turns green.
/// 5. Let go. It should balance now.
/// 6. Let it balance in place or drive it around with the remote.
/// 7. If you touch the Touch LED again, it turns red and the program stops.
///
